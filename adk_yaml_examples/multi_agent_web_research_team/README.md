...
A sophisticated multi-agent system that uses Firecrawl MCP tools for web scraping and coordinates between specialized research and summary agents.
...
3. Set environment variables in `.env` file:
   ...
   **Getting API Keys:**
   ...
   - **Firecrawl**: Get your API key from your Firecrawl account
